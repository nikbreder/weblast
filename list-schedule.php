        ...
        <div class="col-xs-12">
            <div class="box">
                <section class="content-header">
                    <ol class="breadcrumb">
                        <li>
                            <a href="/index.php"><i class="fa fa-dashboard"></i>Главная</a>
                        </li>
                        <li>
                            <a href="list-teacher-schedule.php">Расписание</a></li>
                                ...
                                <tr>
                                    <th colspan="4">
                                        <h4 class="center-block">
                                            <?= $day['name']; ?>
                                            <a href="add-schedule.php?idUser=<?= $id; ?>&idDay=<?= $day['id']; ?>">
                                    ...
                                    <?php foreach ($day['gruppa'] as $gruppa) : ?>
                                        ...
                                        <?php foreach ($gruppa['schedule'] as $schedule) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="delete-schedule.php?id=<?= $schedule['schedule_id']; ?>&idTeacher=<?= $id; ?>">
